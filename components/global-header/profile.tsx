...
export interface GlobalHeaderProfileProps {
	/**
	 ...
	 */
	buttonClassName?: unknown[] | Record<string, unknown> | string;
	/**
 ...
 */
class GlobalHeaderProfile extends React.Component<GlobalHeaderProfileProps> {
	// ### Display Name
	static displayName = GLOBAL_HEADER_PROFILE;

	// ### Default Props
	static defaultProps: Partial<GlobalHeaderProfileProps> = {
		userName: 'User Name',
	};

	constructor(props: GlobalHeaderProfileProps) {
		super(props);
			...
			<Popover {...(popoverProps as unknown as React.ComponentProps<typeof Popover>)}>
				<Button
					className={classnames(
						...
						this.props.buttonClassName as string
					)}
