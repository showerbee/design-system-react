...
export interface GlobalNavigationBarLinkAssistiveText {
	activeDescriptor?: string;
}

export interface GlobalNavigationBarLinkProps {
	/**
	 ...
	 */
	assistiveText?: GlobalNavigationBarLinkAssistiveText;
	/**
	 ...
	 */
	onKeyPress?: React.KeyboardEventHandler<HTMLAnchorElement>;
	/**
 ...
 */
const GlobalNavigationBarLink = (props: GlobalNavigationBarLinkProps) => {
